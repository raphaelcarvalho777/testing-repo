...
export default class TelemetryAPI {
     ...
     */
    requestCollection(domainObject: any, options?: TelemetryRequestOptions): TelemetryCollection;
    /**
     ...
     *          the subscription
     */
    subscribe(domainObject: any, callback: Function, options: TelemetryRequestOptions): Function;
     ...
     *          the subscription
     */
    subscribeToLimits(domainObject: any, callback: Function): Function;
     ...
     * @memberof module:openmct.TelemetryAPI~TelemetryProvider#
     */
    limitDefinition(domainObject: any): LimitsResponseObject;
    /**
     * Get a limit evaluator for this domain object.
     * Limit Evaluators help you evaluate limit and alarm status of individual
     * telemetry datums for display purposes without having to interact directly
     ...
     * @memberof module:openmct.TelemetryAPI~TelemetryProvider#
     */
    getLimits(domainObject: any): LimitsResponseObject;
    #private;
}
...
export type LimitsResponseObject = object;
/**
 * Limit defined for a telemetry property.
 */
export type LimitDefinition = any;
/**
 * Limit definition for a Limit of a telemetry property.
 */
export type LimitDefinitionValue = any;
/**
