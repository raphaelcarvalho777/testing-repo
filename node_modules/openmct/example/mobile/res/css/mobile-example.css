...
@media only screen and (orientation: portrait) and (max-device-width: 767px),
  only screen and (orientation: landscape) and (max-device-width: 767px),
  only screen and (orientation: portrait) and (min-device-width: 768px) and (max-device-width: 1024px),
  only screen and (orientation: landscape) and (min-device-width: 768px) and (max-device-width: 1024px) {
  /* line 28, example/mobile/res/sass/mobile-example.scss */
  .create-button-holder {
    display: block !important;
  }
}

/*# sourceMappingURL=mobile-example.css.map */
